from WoodProblemDefinitionX2 import Stock, Order1, Order2, Order3
import time, os
import numpy as np
...
def run_PSO():
    ...
    fname = "results_PSOx2/results_PSO.csv"
    f = open(fname, "a+")
    ...
    for i in range(0, len(Stock)):
        ...
        plotShapelyPoly(ax[idx][i % 8], remaining[i])
    ...
    name = "results_PSOx2/result_PSO.png"
