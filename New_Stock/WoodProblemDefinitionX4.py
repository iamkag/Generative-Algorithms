...
Stock = [
        ...
        Polygon([(0.0,0), (0,3), (1,3), (1,0)]),
        Polygon([(0.0,0), (0,6), (3,6), (3,0)]),
        Polygon([(0,0), (3, 3), (5,0)]),
        Polygon([(0,0), (6, 4), (5,0)]),
        Polygon([(0,0), (8, 4), (8,0)]),
        Polygon([(0,0), (7, 5), (7,7), (10, 0)]),
        Polygon([(0,0), (3, 10), (15, 15), (15,0)]),
        Polygon([(0.0,0.0), (0, 8), (4, 8), (4, 0), (1,1), (3,1), (3,5), (1,5)]),
        Polygon([(0.0,0), (0,7), (5,5), (5,0)]),
        Polygon([(0.0,0), (0,5), (4,6), (6,0)]),
        Polygon([(0.0,0), (0,4), (4,6), (4,0)]),
        Polygon([(0,0), (4, 1), (6, 3), (6, 1), (6, 4), (8,0)])
        ]
...
def main(Stock):
        ...
        fig.canvas.set_window_title('Stock x 4')
        for i in range(0, len(Stock)):
                ...
                plotShapelyPoly(ax[idx][i % 4], Stock[i])
